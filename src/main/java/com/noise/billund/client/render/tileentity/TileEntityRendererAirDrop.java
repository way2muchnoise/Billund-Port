...
package com.noise.billund.client.render.tileentity;

import com.noise.billund.client.render.models.ModelParachute;
...
public class TileEntityRendererAirDrop extends Render
{
    ...
    private void doRenderFallingSand( com.noise.billund.tileentity.TileEntityAirDrop entity, double x, double y, double z, float f, float f2 )
    {
    ...
    {
        this.doRenderFallingSand( (com.noise.billund.tileentity.TileEntityAirDrop)entity, x, y, z, f, f2 );
    }
}
